...
CREATE TABLE `tag_with_categories` (
  ...
  PRIMARY KEY (`id`),
  KEY `tag_with_categories_category_id_foreign` (`category_id`),
  KEY `tag_with_categories_tag_id_foreign` (`tag_id`),
  CONSTRAINT `tag_with_categories_tag_id_foreign` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`) ON DELETE CASCADE,
